        ...
        <>
          ...
          <GlassCard intensity="high" className="p-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-sm text-[#0A0A0A]/50 mb-1">Total Portfolio Value</p>
              <h2 className="text-4xl font-light text-[#0A0A0A] mb-2">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-left">
                    <p className="text-sm font-medium text-[#0A0A0A]">{asset.symbol}</p>
          ...
          <GlassCard className="p-5">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-[#0A0A0A]">{selectedAsset.name}</p>
                  <p className="text-xs text-[#0A0A0A]/40">{selectedAsset.symbol}</p>
                </div>
              </div>
            ...
            <p className="text-3xl font-medium text-[#0A0A0A] mb-1">
          ...
          <div className="grid grid-cols-4 gap-2">
            ...
            >
              <Send className="w-5 h-5 text-[#0A0A0A]/60" />
          ...
          <GlassCard className="p-5 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="font-medium text-[#0A0A0A]">Crypto Loan</p>
              ...
              <GlassCard key={asset.id} className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#0A0A0A]/40">{asset.symbol}</p>
                  </div>
                  <div className="text-right">
        ...
        {showActionModal && (
          ...
          >
            ...
            >
              ...
              {/* Asset Selection */}
              <div className="mb-4">
                <p className="text-sm font-medium text-[#0A0A0A] mb-2">Asset</p>
                  ...
                  {cryptoAssets.map((asset) => (
                    <button
                      ...
                      className={`flex-1 py-3 px-2 rounded-xl border-2 transition-all flex flex-col items-center ${
                        selectedAsset.id === asset.id
                          ? 'border-[#0A0A0A] bg-[#0A0A0A]/5'
                          : 'border-transparent bg-[#F7F9F4]'
                      }`}
                    >
                      <span className="text-sm">{asset.symbol}</span>
                      <span className="text-xs text-[#0A0A0A]/40">{asset.balance}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-2 p-4 bg-[#F7F9F4] rounded-xl">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="flex-1 bg-transparent outline-none text-lg text-[#0A0A0A]"
                  />
              ...
              {showActionModal === 'send' && (
                <div className="mb-4">
                  <p className="text-sm font-medium text-[#0A0A0A] mb-2">Recipient Address</p>
                  <div className="flex items-center gap-2 p-4 bg-[#F7F9F4] rounded-xl">
                    <input
                      type="text"
                      ...
                      className="flex-1 bg-transparent outline-none text-sm text-[#0A0A0A]"
                    />
                    <QrCode className="w-5 h-5 text-[#0A0A0A]/40 cursor-pointer" />
                  </div>
                </div>
              )}
              ...
              {showActionModal === 'receive' && (
                <div className="mb-4">
                  <p className="text-sm font-medium text-[#0A0A0A] mb-2">Your {selectedAsset.symbol} Address</p>
                  <div className="p-4 bg-[#F7F9F4] rounded-xl">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-xs text-[#0A0A0A]/40 truncate flex-1 mr-2">
                    ...
                    {showQrCode && (
                      <div className="mt-3 p-4 bg-white rounded-xl flex justify-center">
                        <div className="w-32 h-32 bg-[#F7F9F4] rounded-xl flex items-center justify-center">
                          <QrCode className="w-24 h-24 text-[#0A0A0A]/20" />
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <GlassCard className="p-4 mb-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Zap className="w-4 h-4 text-[#0A0A0A]/40" />
                    <span className="text-sm text-[#0A0A0A]">Network Fee</span>
                  </div>
